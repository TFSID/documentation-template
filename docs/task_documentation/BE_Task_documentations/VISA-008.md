# VISA-008: Consular Appointment Booking

## Deskripsi Tugas
Sistem booking appointment dengan konsulat
...
## Next Steps
Setelah VISA-008 selesai, lanjut ke implementasi fitur berikutnya untuk melengkapi modul Manajemen Visa/Paspor.
